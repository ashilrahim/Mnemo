        ...
        <div className="w-full relative flex flex-col items-center justify-center gap-3">
          ...
          >
            <div className="flex flex-col items-start">
              ...
              <p className="text-slate-500 text-md">
                <span className="text-black font-medium">10 Credits</span>/month
              </p>
            </div>
            <div
          ...
          >
            <div className="flex flex-col items-start">
              ...
              <p className="text-slate-500 text-md">
                <span className="text-black font-medium">50 Credits</span>/month
              </p>
            </div>
            <div
              className="border-2 border-slate-500 size-6 rounded-full mt-0.5 p-1 flex items-center justify-center"
          ...
          >
            <div className="flex flex-col items-start">
              ...
              <p className="text-slate-500 text-md">
                <span className="text-black font-medium">75 Credits</span>/month
              </p>
            </div>
            <div
              className="border-2 border-slate-500 size-6 rounded-full mt-0.5 p-1 flex items-center justify-center"
          ...
          <div
            className={`w-full h-[110px] absolute top-0 border-[3px] border-black rounded-2xl`}
            style={{
              transform: `translateY(${active * 110 + 12 * active}px)`,
              transition: "transform 0.3s",
            }}
          ></div>
        </div>
